# -*- coding: utf-8 -*-
"""
Created on Sun Feb 17 00:50:43 2019
...
def main():
    ...
    startss = os.listdir(r"C:\Users\dayao\Desktop\Stuffs when I'm in the U.S\babe")
    time.sleep(2)
    for starts in startss:
        start = ''.join(starts)
        sta = "C:/Users/dayao/Desktop/Stuffs when I'm in the U.S/babe/" + start
        end = "C:/Users/dayao/Desktop/Stuffs when I'm in the U.S/babe/" + 'HD_' + start
